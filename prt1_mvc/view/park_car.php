...
<?php session_start() ?>
	...
	<section class="content-wrapper">
		<form action="park.php" method="post" class="form-horizontal">
		  <fieldset>
		    <legend class="text-success">Aparcar vehículo</legend>
		    ...
		    <div class="form-group">
		      <div class="col-lg-10">
		        <button name="submit" type="submit" class="btn btn-success">Aparcar Coche</button>
	...
	<aside class="info-wrapper">
		<div class="wrapper">
			<p class="sq-text">Indicar tamaño del coche para poder aparcarlo en el parking</p>
		</div>	
	</aside>
